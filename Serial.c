...
#elif defined  __UART1
  #define UART    LPC_UART1
#elif defined  __UART2
...
#elif defined __UART2
	LPC_SC->PCONP |= ((1 << 24) | (1 << 15)); /* enable power to UART2 & IOCON   */
  LPC_PINCON->PINSEL0 |=  (2 << 19);        /* Pin P0.10 used as TXD2           */
  LPC_PINCON->PINSEL0 |=  (2 << 21);        /* Pin P0.11 used as RXD2           */
#endif	
//----------------------------------------------------------------------------------------------
